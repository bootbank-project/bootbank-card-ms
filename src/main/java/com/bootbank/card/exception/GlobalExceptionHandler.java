...
import com.bootbank.card.exception.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRecordNotFoundException(RecordNotFoundException ex) {
        ...
        return ResponseEntity
                ...
                .body(ErrorResponse.of(code.getStatus(), code.getError(), ex.getMessage()));
    }

    @ExceptionHandler(BadRequestException.class)
    public ResponseEntity<ErrorResponse> handleBadRequestException(RecordNotFoundException ex) {
        ErrorCode code = ex.getErrorCode();
        return ResponseEntity
                .status(code.getHttpStatus())
                .body(ErrorResponse.of(code.getStatus(), code.getError(), ex.getMessage()));
